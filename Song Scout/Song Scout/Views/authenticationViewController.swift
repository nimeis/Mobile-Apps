...
//struct firestoreAuthenticationViewController: UIViewControllerRepresentable {
//    var authUI: FUIAuth
//
...
struct spotifyAuthenticationViewController: UIViewControllerRepresentable {
    var onSignedIn: (() -> Void)?
    typealias UIViewControllerType = spotifyViewController    
    
    func makeUIViewController(context: Context) -> spotifyViewController {
        let viewController = spotifyViewController()
        viewController.onSignedIn = onSignedIn
