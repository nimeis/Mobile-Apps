...
struct previousSEScores: View {
    @AppStorage("selfEvaluation0") var score0 = 0
    @AppStorage("selfEvaluation1") var score1 = 0
    @AppStorage("selfEvaluation2") var score2 = 0
    @AppStorage("selfEvaluation3") var score3 = 0
    @AppStorage("selfEvaluation4") var score4 = 0
...
struct previousSEScores_Previews: PreviewProvider {
