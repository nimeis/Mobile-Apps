...
struct previousSHScores: View {
    @AppStorage("stableHome0") var score0 = 0
    @AppStorage("stableHome1") var score1 = 0
    @AppStorage("stableHome2") var score2 = 0
    @AppStorage("stableHome3") var score3 = 0
    @AppStorage("stableHome4") var score4 = 0
...
struct previousSHScores_Previews: PreviewProvider {
